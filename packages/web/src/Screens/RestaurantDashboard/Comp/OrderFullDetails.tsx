  ...
  useEffect(() => {
    try {
      if (rider === "" && orders.length > 0)
        setRider(orders[orderIndex].Rider.FirstName);
                ...
                >
                  <CardMedia>
                    ...
                    <img
                      ...
                      src={orders[orderIndex].OrderItems[0].imageName}
                      alt="ordered"
                    ></img>
                    <Grid
                      container
                  ...
                  <CardContent className={classes.cardContent}>
                        ...
                        {orders[orderIndex].OrderItems.map((item, index) => (
                          <>
                            <Grid item xs={12} md={4} key={index}>
                              <Typography>Order Item {index + 1}:</Typography>
                              <Typography>
                                {`
                    ...
                    <Grid container direction="row" spacing={1}>
                      <Grid item xs={12} md={4}>
                        ...
                        <Typography>{orders[orderIndex]._id}</Typography>
                      </Grid>
                      <Grid item xs={12} md={4}>
                        <Typography className={classes.boldSubtitle}>
                          Order Date
