        ...
        {[
          ...
          referralPath === "/AdminDashboard" && text === "Overview" ? (
            <ListItem button key={text}>
              <ListItemIcon>
                {index === 0 ? (
                  <img src="Images/OverviewActive.png" alt="square icon" />
                ) : index === 1 ? (
                  <img src="Images/EmployeesActive.png" alt="truck icon" />
                ) : index === 2 ? (
                  <img src="Images/OrdersActive.png" alt="BlackMarket icon" />
                ) : index === 3 ? (
                  <img
            ...
            <ListItem button key={text}>
              <ListItemIcon>
                {index === 0 ? (
                  ...
                  <img src="Images/EmployeesIActive.png" alt="truck icon" />
                ) : index === 2 ? (
                  <img src="Images/OrdersActive.png" alt="BlackMarket icon" />
                ) : index === 3 ? (
                  <img
            ...
            <ListItem button key={text}>
              <ListItemIcon>
                {index === 0 ? (
                  ...
                  <img src="Images/EmployeesActive.png" alt="AEmployeees" />
                ) : index === 2 ? (
                  <img src="Images/OrdersIActive.png" alt="BlackMarket icon" />
                ) : index === 3 ? (
                  <img
                    src="Images/OrganizationsIActive.png"
                    alt="OrganizationsIActive icon"
              ...
              <ListItemIcon>
                {index === 0 ? (
                  ...
                  <CloudDownloadRounded
                    style={{ color: "#FF5E14", width: "30px", height: "31px" }}
                  />
                ) : (
                  <MailIcon />
                )}
            ...
            <Link to="/AdminDashboard" className={classes.inactiveItemLink}>
              <ListItem button key={text}>
                <ListItemIcon>
                  {index === 0 ? (
                    <img src="Images/OverviewIActive.png" alt="square icon" />
                  ) : index === 1 ? (
                    <img
            ...
            <Link to="/AdminOrders" className={classes.inactiveItemLink}>
              <ListItem button key={text}>
                <ListItemIcon>
                  {index === 0 ? (
                    <img src="Images/GroupSquareIcon.png" alt="square icon" />
                  ) : index === 1 ? (
                    <img src="Images/EmployeesIActive.png" alt="truck icon" />
                  ) : index === 2 ? (
                    <img
              ...
              <ListItem button key={text}>
                <ListItemIcon>
                  {index === 0 ? (
                    ...
                    <img src="Images/EmployeesIActive.png" alt="IEmployeees" />
                  ) : index === 2 ? (
                    <img
                      src="Images/BackMarketPlaceIcon.png"
                      alt="BlackMarket icon"
            ...
            <ListItem button key={text} style={{ marginTop: "5%" }}>
              <ListItemIcon>
                {index === 0 ? (
                  ...
                  <CloudDownloadRounded
                    style={{ color: "#D2D3D8", width: "30px", height: "31px" }}
                  />
                ) : (
                  <MailIcon />
                )}
    ...
    <>
      {isMatchMedium ? (
        ...
        >
          ...
          referralPath === "/organisations" ? (
          ...
          ) : referralPath === "/AdminDashboard" ||
            referralPath === "/admindashboard" ? (
            <span>
              <Link to="/AdminDashboard" className={classes.links}>
                Dashboard
              </Link>
            </span>
            ...
            referralPath === "/adminordersdetails" ? (
            <span>
              <Link to="/AdminOrderSDetails" className={classes.links}>
                Order Details
              </Link>
            </span>
            ...
            referralPath === "/adminsettings" ? (
            <span>
              <Link to="/AdminSettings" className={classes.links}>
                Settings
              </Link>
            </span>
          ) : referralPath === "/PaySettings" ||
            referralPath === "/paysettings" ? (
            <span>
              <Link to="/PaySettings" className={classes.links}>
                Pay Settings
              </Link>
            </span>
          ) : (
