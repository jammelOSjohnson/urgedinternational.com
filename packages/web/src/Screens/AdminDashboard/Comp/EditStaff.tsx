...
export const EditStaff: React.FC = () => {
  ...
  const [values, setValues] = React.useState<State>({
    ...
    Menu: [],
    ImageName:
      import.meta.env.REACT_APP_DEFAULT_RIDER_LOGO !== undefined
        ? import.meta.env.REACT_APP_DEFAULT_RIDER_LOGO
        : "",
    isAvailable: false,
    disabled: false,
  ...
  useEffect(() => {
    if (riders.length > 0 && selectedRider !== undefined) {
      setValues({
        ...
        Role:
          riders[selectedRider].Position !== null &&
                      ...
                      <Grid item xs={12}>
                        ...
                        >
                          ...
                          <Select
                            ...
                            required
                          >
                            <MenuItem value={"Select Staff Role"} key={0}>
                              Select Staff Role
                            </MenuItem>
                            <MenuItem value={"Rider"} key={1}>
                              Delivery Personel
                            </MenuItem>
                            <MenuItem value={"Urged_Staff"} key={2}>
                              Operations Staff
                            </MenuItem>
