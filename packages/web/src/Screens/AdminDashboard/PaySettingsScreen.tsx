  ...
  useEffect(() => {
    try {
      ...
      if (data.getPaySettings !== null) {
        ...
        if (paySet !== null) {
          setState({
            deliveryFee: paySet.deliveryFee.toString(),
            checkedA: paySet.perDeliveryEnabled,
            checkedB: paySet.percentagePerOrderTotal,
            value: paySet.value.toString(),
            closed: paySet.closed,
            badWeather: paySet.badWeather,
            holiday: paySet.holiday,
            message: paySet.message,
            _id: paySet._id,
          });
        }
      }
    ...
    try {
      if (data.getPaySettings !== null && data.getPaySettings !== undefined) {
        let newPaySettings = {
          ...
          closed: state.closed,
          badWeather: state.badWeather,
          holiday: state.holiday,
          message: state.message || "",
          deliveryFee: parseInt(state.deliveryFee),
        };
