        ...
        <div className={classes.innerContainer}>
          <Grid container spacing={0}>
            <Grid item xs={12} md={6}>
              <Typography>
                <Typography className={classes.Text1}>Contact us</Typography>
              </Typography>
              <Typography>
              ...
              <form style={{ paddingLeft: "15%", paddingRight: "15%" }}>
                <Grid container spacing={2}>
                  <Grid item xs={6}>
                    <FormControl variant="outlined">
                      <InputLabel htmlFor="firstname" className={classes.root}>
                        First name
                      </InputLabel>
                      <OutlinedInput
                  ...
                  <Grid item xs={6}>
                    ...
                    >
                      <InputLabel htmlFor="lastname" className={classes.root}>
                        Last Name
                      </InputLabel>
                      <OutlinedInput
                        className={clsx(classes.firstTextField, classes.root)}
                ...
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="subject" className={classes.root}>
                    Subject
                  </InputLabel>
                  <OutlinedInput
                    className={clsx(classes.firstTextField, classes.root)}
                ...
                <FormControl fullWidth variant="outlined">
                  <InputLabel htmlFor="message" className={classes.root}>
                    Message
                  </InputLabel>
                  <OutlinedInput
                    className={clsx(classes.firstTextField, classes.root)}
