    ...
    <>
      <Container maxWidth="xl" className={classes.mainContainer}>
        ...
        <Typography paragraph={true} className={`${classes.secDescription}`}>
          ...
          et euismod
          <br />
          tempor. Adipiscing elementum vestibulum in eget enim donec sed
          tincidunt.
        </Typography>
            ...
            <Grid md={6}>
              <Grid container spacing={0}>
                <Grid xs={12} style={{ padding: "5% 0 0 0%" }}>
                  <Typography className={classes.text1}>You Order</Typography>
                ...
                <Grid md={12}>
                  <Typography className={classes.text1}>We Pickup</Typography>
                  <Typography className={classes.text2}>
                    {/* Lorem ipsum dolor sit amet,<br />
                                            consectetur adipiscing elit.  */}
                  </Typography>
                ...
                <Grid md={12}>
                  <Typography className={classes.text1}>We Deliver</Typography>
                  <Typography className={classes.text2}>
                    {/* Lorem ipsum dolor sit amet,<br />
                                            consectetur adipiscing elit.  */}
                  </Typography>
        ...
        {isMobile ? (
          <Grid container spacing={0} className={classes.root}>
            <Grid xs={12} md={6}>
              <img
                src="Images/Errand Services.webp"
                width="100%"
