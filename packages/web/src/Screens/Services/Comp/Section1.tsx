...
//import CSS
import { Container, Grid, Typography, Theme, Button, Card, CardMedia, CardContent, useMediaQuery, useTheme,  } from '@mui/material';
      ...
      <div style={{ position: "relative" }} id="HomeSlide">
        <Carousel nextIcon={false} prevIcon={false}>
          <Carousel.Item>
            ...
            />
            <img
              src="Images/FoodDHomeSlide.webp"
              className={clsx(classes.image, "mobileCaroselImage")}
              alt="KFC Bucket"
            />
            <Carousel.Caption style={{ top: "5%" }}>
              ...
              >
                <Grid
                  ...
                  lg={6}
                  xl={3}
                  className={classes.heroTextMargin}
                >
                  <Typography
                    className={clsx(classes.heroText1, "mobileheroText1")}
                    align="left"
                  >
                    Enjoy Hassle Free
                  ...
                  <Typography
                    className={clsx(classes.heroText2, "mobileheroText2")}
                    align="left"
                  >
                    Select your favorite food from a wide range of restaraunts.
                            ...
                            <Grid key={0} item>
                              ...
                              >
                                <CardMedia className={classes.cardImage}>
                                  <img
                                    src="Images/YellowFoodDeliveryService.png"
                                    alt="YellowFoodDeliveryService"
                                  ></img>
                                </CardMedia>
                          ...
                          <Grid container justifyContent="center" spacing={2}>
                            <Grid key={1} item>
                              <Card className={classes.cardMiddle}>
                                <CardMedia className={classes.cardImage}>
                                  <img
                                    src="Images/whitetruckIconImage.png"
                                    alt="whitetruckIconImage"
                                  ></img>
                                </CardMedia>
                                <CardContent className={classes.cardContent}>
                                  <Typography
                                    gutterBottom
                                    className={classes.cardTitleMiddle}
                                  >
                                    Marketplace
                                  </Typography>
                                </CardContent>
                        ...
                        <Grid container justifyContent="center" spacing={2}>
                          <Grid key={2} item>
                            <Card className={classes.card}>
                              <CardMedia className={classes.cardImage}>
                                <img
                                  src="Images/YellowMarketPlaceService.png"
                                  alt="YellowMarketPlaceService"
                                ></img>
                              </CardMedia>
                              <CardContent className={classes.cardContent}>
                                <Typography
          ...
          <Carousel.Item>
            ...
            />
            <img
              src="Images/package delivery.webp"
              className={clsx(classes.image, "mobileCaroselImage")}
              alt="KFC Bucket"
            />
            <Carousel.Caption style={{ top: "5%" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    Enjoy Super Fast
                    <span className={classes.heroSubText2}> Package</span>{" "}
                    Delivery.
                  </Typography>
                  <Typography
                    className={clsx(classes.heroText2, "mobileheroText2")}
                    align="left"
                  >
                    We deliver Packages of all shapes and sizes. Schedule a
                    pick-up and we will drop them off wherever you like.
                  </Typography>
                </Grid>
              </Grid>
              <div
