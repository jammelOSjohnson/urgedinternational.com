          ...
          >
            <Grid container direction="row" spacing={1}>
              ...
              >
                <Fade in={open2}>
                  <div
                    className={clsx(classes.paper2, "modalMobile")}
                    style={{ maxHeight: "90vh" }}
                  >
                    <h2
                      id="transition-modal-title"
                      style={{ textAlign: "center", color: "#FF5E14" }}
                    >
                      How It Works?
                    </h2>
                    <Link
                        ...
                        >
                          <Card className={classes.card}>
                            <CardContent className={classes.cardContent}>
                              ...
                              >
                                Shop online then experience safe, convenient
                                &amp; reliable shipping from USA to Jamaica for
                                both personal &amp; commercial purpose.
                                <br />
                                <br />
                                We convey by Air and Sea.
                              </Typography>
                              ...
                              <Typography
                                variant="h6"
                                className={classes.paragraphHeadings}
                              >
                                How it Works :
                              </Typography>
                              <br />
                              ...
                              >
                                ...
                                <span className={classes.paragraph}>
                                  Shop at your favorite stores online and send
                                  the order to your new US shipping address.
                                  Also have friends, business partners or family
                                  send packages to your US shipping address.
                                </span>
                              </Typography>
                              <br />
                              <Typography
                              ...
                              >
                                2.{" "}
                                <span className={classes.paragraph}>
                                  We receive your order at our US warehouse and
                                  notify you.
                                </span>
                              </Typography>
                              <br />
                              ...
                              >
                                3.{" "}
                                <span className={classes.paragraph}>
                                  We will send a notification when your package
                                  is in Jamaica and ready for delivery.
                                </span>
                              </Typography>
                              <br />
                              <hr />
                              ...
                              <Typography>
                                When your package arrives, we provide free
                                delivery to your home or office in May Pen and
                                island wide delivery for an affordable fee.
                              </Typography>
                              <hr />
                            </CardContent>
                          </Card>
                      ...
                      <Grid item xs={12}>
                        ...
                        >
                          ...
                          <Typography className={classes.paragraph}>
                            ...
                            Packages deemed by Customs as intended for personal
                            use, valued in excess of US$50.00 (C.I.F.) may be
                            subject to Customs Duty Charges. For more details as
                            it relates to customs charges, please visit{" "}
                            <a
                            ...
                            May Pen: Packages under 10lb Free Delivery by Urged
                            <br />
                            <br />
                            Other Parishes: Delivery starts at $300
                            <br />
                            <br />
                            Third party couriers includes Zipmail, Knutsford
                            Express or Doorway Express
                            <br />
                            <br />
