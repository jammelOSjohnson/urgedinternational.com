      ...
      if (jaday === "" && today === 0) {
        ...
        try {
          if (currentTime !== null && currentTime !== undefined) {
            ...
            let decision =
              (isPm && parseInt(closeTimeFinal) > parseInt(jaTimeFinal[0])) ||
              (isAm && parseInt(jaTimeFinal[0]) >= parseInt(openTimeFinal)) ||
              (isPm &&
                parseInt(jaTimeFinal[0]) === 12 &&
                parseInt(closeTimeFinal) < parseInt(jaTimeFinal[0]));
            //console.log(decision)
            if (paySettings !== undefined) {
              decision =
                paySettings.closed === true ||
                paySettings.badWeather === true ||
                paySettings.holiday === true
                  ? false
                  : decision;
            }
            setisOpen(decision);
                ...
                <Grid item direction="row" spacing={1}>
                    ...
                    <Grid item direction="row" spacing={1}>
                      ...
                      <Grid item xs={12} sm={6}>
                        {isOpen ? (
                          ...
                          <Typography variant={"h6"} className={classes.Closed}>
                            Closed
                          </Typography>
                        )}
                      </Grid>
                  ...
                  <Grid item xs={12}>
                    <Typography variant={"h6"}>
                      <LocationOnRounded color="primary" /> Address:{" "}
                      {restaurant[0].City}
                    </Typography>
                  </Grid>
                  <Grid item xs={12}>
