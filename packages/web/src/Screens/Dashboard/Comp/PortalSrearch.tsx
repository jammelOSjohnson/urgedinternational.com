...
const PortalSearch: React.FC<Props> = function PortalSearch({
  color,
  backgroundColor,
  screen,
}) {
  ...
  if (screen === "mobile") {
                    ...
                    return (
                      <>
                        <Link
                          onClick={(e) => {
                            e.preventDefault();
                            handleSelectedRestaurantItem(val);
                          }}
                          className={classes.link}
                        >
                          <div style={{ textAlign: "left" }} key={index}>
    ...
    return (
      <>
        <div
          style={{ backgroundColor: backgroundColor, display: "flex", top: 0 }}
        >
          <FormControl variant="outlined" style={{ color: color }}>
            {/* <InputLabel htmlFor="search" className={classes.root}>Portal Search</InputLabel> */}
            <OutlinedInput
