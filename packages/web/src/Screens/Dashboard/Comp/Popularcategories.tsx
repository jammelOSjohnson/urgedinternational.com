              ...
              {restCategories.map((item, index) => {
                return (
                  <Link
                    ...
                    onClick={(e) => filterCat(e, item.cat)}
                    key={index}
                  >
                    <Grid item>
                      <Card
                        className={clsx(classes.card, "cardSizeCategories")}
                      >
                ...
                <TableRow key={0}>
                  <TableCell align="center">
                    ...
                    >
                      <Card className={classes.cardMobile}>
                        <CardMedia className={classes.cardImage}>
                          <img
                            src="Images/FoodDeliveryBreakfast.png"
                            alt="img9"
                          ></img>
                        </CardMedia>
                        <CardContent className={classes.cardContent}>
                  ...
                  <TableCell align="center">
                    ...
                    >
                      <Card className={classes.cardMobile}>
                        <CardMedia className={classes.cardImage}>
                          <img
                            src="Images/FoodDeliveryLunch.png"
                            alt="img10"
                          ></img>
                        </CardMedia>
                        <CardContent className={classes.cardContent}>
                  ...
                  <TableCell align="center">
                    ...
                    >
                      <Card className={classes.cardMobile}>
                        <CardMedia className={classes.cardImage}>
                          <img
                            src="Images/FoodDeliveryDessert.png"
                            alt="img11"
                          ></img>
                        </CardMedia>
                        <CardContent className={classes.cardContent}>
                  ...
                  <TableCell align="center">
                    ...
                    <Card className={classes.cardMobile}>
                      <CardMedia className={classes.cardImage}>
                        <img
                          src="Images/FoodDeliveryChinese.png"
                          alt="img12"
                        ></img>
                      </CardMedia>
                      <CardContent className={classes.cardContent}>
                ...
                <TableRow key={1}>
                  ...
                  <TableCell align="center">
                    ...
                    >
                      <Card className={classes.cardMobile}>
                        <CardMedia className={classes.cardImage}>
                          <img
                            src="Images/FoodDeliveryDinner.png"
                            alt="img14"
                          ></img>
                        </CardMedia>
                        <CardContent className={classes.cardContent}>
                  ...
                  <TableCell align="center">
                    ...
                    <Card className={classes.cardMobile}>
                      <CardMedia className={classes.cardImage}>
                        <img
                          src="Images/FoodDeliveryPastry.png"
                          alt="img15"
                        ></img>
                      </CardMedia>
                      <CardContent className={classes.cardContent}>
                  ...
                  <TableCell align="center">
                    ...
                    <Card className={classes.cardMobile}>
                      ...
                      >
                        <img
                          src="Images/FoodDeliverySalads.png"
                          alt="img16"
                        ></img>
                      </CardMedia>
                      <CardContent className={classes.cardContent}>
