    ...
    if (cartItems.length > 0) {
      ...
      if (cartItems[0].restaurantName === restaurant[0].FirstName) {
        ...
        setValues({
          ...
          itemCategory: item.MenuCategory,
          restaurantName: item.FirstName,
        });
        setOpen(true);
      } else {
        setItem(item);
              ...
              <Fade in={open}>
                <div className={classes.paper}>
                  ...
                  >
                    ...
                    <Grid item xs={12}>
                      {restaurant[0].FirstName === "Kentucky Fried Chicken" &&
                      values.itemCategory !== "Zingers" &&
                      values.itemCategory !== "Famous Bowl" &&
                      values.itemCategory !== "Buckets" &&
                      values.itemCategory !== "Hot Wings" &&
                      values.itemCategory !== "Popcorn Chicken" &&
                      values.itemCategory !== "Sides" ? (
                        <form onSubmit={(e) => AddToCart2(e, values)}>
                          <Grid
                            ...
                            alignItems="center"
                          >
                            <FastFoodChickenFlavor
                              props={values}
                              handleChange={handleChange}
                              menuItems={restaurant[0].MenuItems}
                            />
                            ...
                            <Grid item xs={12}>
                              ...
                              >
                                ...
                                <Select
                                  ...
                                  fullWidth
                                >
                                  <MenuItem value={"Contact me"}>
                                    Contact me
                                  </MenuItem>
                                  <MenuItem value={"Delivery rider can decide"}>
                                    Delivery rider can decide
                                  </MenuItem>
                                  <MenuItem value={"Refund for this item"}>
                                    Refund for this item
                                  </MenuItem>
                                  <MenuItem value={"Cancel my entire Order"}>
                      ...
                      ) : restaurant[0].FirstName ===
                          "Kentucky Fried Chicken" &&
                        values.itemCategory === "Zingers" &&
                        values.itemName !== "BBQ Zinger Only" &&
                        values.itemName !== "Spicy Zinger Only" ? (
                        <form onSubmit={(e) => AddToCart3(e, values)}>
                          ...
                          "Kentucky Fried Chicken" &&
                        values.itemCategory === "Famous Bowl" &&
                        values.itemName !== "Famous Bowl Only" ? (
                        ...
                        <form onSubmit={(e) => AddToCart(e, values)}>
                          {values.itemCategory !== "Pastries" &&
                          values.itemCategory !== "Beverages" &&
                          values.itemCategory !== "Sides" &&
                          values.itemCategory !== "Loaves" &&
                          values.itemCategory !== "Patties" ? (
                            <Grid item xs={12} sm={12}>
                              <FormControl
                                variant="outlined"
                                className={classes.formControl}
                    ...
                    <Grid item xs={12}>
                      <Grid item xs={12}>
                        <Typography>
                          ...
                          {restaurant[0].FirstName} Restaurant.
                        </Typography>
                      </Grid>
                      <Grid item xs={10} sm={12}>
                        <Button
              ...
              {filteredMenuItems.length !== 0
                ? filteredMenuItems.map((item, index) => (
                    <Grid
                      ...
                      lg={3}
                      xl={3}
                      className={clsx(classes.gridSpacing, "cardMobile")}
                      key={index}
                    >
                      <Card
                        className={clsx(classes.root, "cardMobile")}
                        style={{ minHeight: "446.99px" }}
                      >
                        <CardActionArea>
                          <CardMedia
