...
export const FastFoodChickenFlavor: React.FC<{props:State, handleChange: any, menuItems: any}> = function FastFoodChickenFlavor({props,handleChange, menuItems}) {
    ...
    return (
        <>
            {
                props.itemCategory !== "Hot Wings" && props.itemCategory !== "Popcorn Chicken" && props.itemCategory !== "Zingers" &&  props.itemCategory !== "Famous Bowl" 
                && props.itemCategory !=="Buckets" && props.itemCategory !=="Sides" && props.itemCategory !== "CHCKN Combos" && props.itemCategory !=="Salads" 
                && props.itemCategory !=="Seafood" && props.itemCategory !=="Signature Sides" && props.itemCategory !=="Family Meals" && props.itemCategory !=="Sandwiches" 
                && props.itemCategory !== "Tenders" && props.itemCategory !== "Chicken Combos" ?
                    <>
                ...
                :props.itemCategory === "Family Meals"?
                <>
                    <Grid item xs={12}>
                        <FormControl variant="outlined" className={classes.formControl} fullWidth>
                            <InputLabel id="demo-simple-select-outlined-label">choice</InputLabel>
                ...
                :props.itemCategory === "Chicken Combos"?
                <>
                    <Grid item xs={12} sm={6} md={6} lg={6}>
                        <FormControl variant="outlined" className={classes.formControl} fullWidth>
                            <InputLabel id="demo-simple-select-outlined-label">choice</InputLabel>
