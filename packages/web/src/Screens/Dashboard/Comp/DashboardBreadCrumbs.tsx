    ...
    return (
      <>
          <Typography variant="h6" style={{fontWeight: "bold", background: "transparent"}}>
              ...
              <span ><PlayArrowRounded /> <span style={{color: "#FF5E14"}}>PRIVACY POLICY</span></span> :
              ...
              <span><PlayArrowRounded /> <Link to="/Uship" className={classes.link} style={{color: "#FF5E14"}}>USHIP</Link></span> : ""}
          </Typography>
      </>
    );
}
