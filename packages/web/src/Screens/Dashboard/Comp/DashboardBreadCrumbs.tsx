    ...
    <>
      ...
      >
        ...
        referralPath === "/FoodDelivery" ? (
          <span>
            <PlayArrowRounded />{" "}
            <span style={{ color: "#FF5E14" }}>FOOD DELIVERY</span>
          </span>
        ) : referralPath === "/privacy" || referralPath === "/Privacy" ? (
          <span>
            <PlayArrowRounded />{" "}
            <span style={{ color: "#FF5E14" }}>PRIVACY POLICY</span>
          </span>
        ) : referralPath === "/orderhistory" ||
          referralPath === "/OrderHistory" ? (
          <span>
            <PlayArrowRounded />
            <span style={{ color: "#FF5E14" }}>Order History</span>
          </span>
          ...
          <span>
            ...
            <PlayArrowRounded />{" "}
            <span style={{ color: "#FF5E14" }}>RESTAURANTS</span>
          </span>
        ) : referralPath === "/Menu" ||
          referralPath === "/menu" ||
          ...
          <span>
            ...
            <PlayArrowRounded /> <span style={{ color: "#FF5E14" }}>MENU</span>
          </span>
        ) : referralPath === "/Rates" || referralPath === "/rates" ? (
          <span>
            <Link to="/Uship" className={classes.link}>
              <span style={{ color: "#FF5E14" }}>
                <ArrowBackRounded /> RETURN
              </span>
            </Link>
          </span>
