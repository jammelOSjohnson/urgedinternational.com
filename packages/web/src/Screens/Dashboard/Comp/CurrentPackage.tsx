...
export const CurrentPackage: React.FC = function CurrentPackage() {
    ...
    return (
      <StepConnector
        sx={{
          ...
          "& .MuiStepConnector-line": connectorLineSx,
        }}
      />
    );
  }
  ...
  }, [orders, activeStep, latestOrderStatus]);
