...
export const RestaurantMenuResult: React.FC = function RestaurantMenuResult(props) {
    const classes = useStyles();
    
    var { value }  = useAppData();
    var { cartItems ,restaurants, selectedRestaurantName, selectedRestaurant, selectedMenuSearchItem,
        addItemToCart, userInfo, clearCartItems } = value;
            ...
            <>
                ...
                {isMaatchMedium?
                    <>
                        ...
                        <Grid container direction="row" spacing={2} className={classes.root} alignItems='flex-start' justifyContent='flex-start'>
                            {
