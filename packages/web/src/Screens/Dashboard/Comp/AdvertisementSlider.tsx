  ...
  return (
    <>
          ...
          <Carousel nextIcon={false} prevIcon={false}>
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                >
                  Here at Urged, Quality and Time is our main priority. You can
                  trust us to be on-time with your packages and food.
                </Typography>
                <Typography className={classes.btnLayout}>
                  <a
                    href="#categories"
                    title="categories"
                    className={clsx("inactiveItemLink")}
                  >
      ...
      {isMobile ? (
        <div style={{ position: "relative" }}>
          <img
            className={classesMobile.imageMobile}
            src="Images/Rocket.png"
            alt="rocket logo"
          />
          <Carousel nextIcon={false} prevIcon={false}>
            <Carousel.Item>
              ...
              <Carousel.Caption>
                ...
                <Typography
                  className={`${classes.fonts} ${classesMobile.sliderText}`}
                >
                  Here at Urged, Quality and Time is our main priority. You can
                  trust us to be on-time with your packages and food.
                </Typography>
