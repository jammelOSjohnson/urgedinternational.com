...
export const HeaderLeft: React.FC = function HeaderLeft() {
  ...
  const LightTooltip = (props: React.ComponentProps<typeof Tooltip>) => (
    <Tooltip
      {...props}
      slotProps={{
        tooltip: {
  ...
  const [, setRestItems] = React.useState<restItemsArr[]>([]);
  ...
  }, [restaurants, generalLocation, referralPath, targetLocation]);
    ...
    >
            ...
            >
              <ListItem button>
                <ListItemIcon>
                  {index === 0 ? (
                    <img
                      src={window.location.origin + "/Images/Group 564.png"}
                      alt="square icon"
                    />
                  ) : index === 1 ? (
                    <img
      ...
      <List>
        ...
        {/* <IconButton
                        ...
                        >
                            <img src={
                        window.location.origin + "/Images/collapse_icon1.svg"} style={{width: "100%"}} alt="icon"/>
                        </IconButton>
                        <IconButton
                            color="inherit"
                            aria-label="open drawer"
                ...
                >
                  <Grid item xs={12}>
                    <Typography style={{ textAlign: "center" }}>
                      We provide both errand services and package delivery.
                      <br />
