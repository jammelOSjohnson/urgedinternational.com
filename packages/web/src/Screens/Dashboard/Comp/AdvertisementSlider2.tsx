      ...
      {isMatchMedium ? (
        <div style={{ position: "relative" }} id="FoodSlide">
          <img
            ...
            src="Images/JuiciFood.png"
            alt="KFC Bucket"
          />
          <Carousel
            nextIcon={false}
            prevIcon={false}
            className={classesMobile.slider}
          >
            <Carousel.Item>
              <img
                className="d-block"
              ...
              <Carousel.Caption style={{ top: "5%" }}>
                <Typography
                  className={`${classes.fonts} ${classes.sliderSlogan}`}
                >
                ...
                <Typography
                  className={`${classes.fonts} ${classes.sliderText}`}
                >
                  With Urged, Quality and Time is our main priority. You can
                  trust us to be on-time with your food from any restaraunt.
                </Typography>
                <Typography className={classes.btnLayout}>
                  ...
                  >
                    <Button className={clsx(classes.Button, "restaurants-btn")}>
                      <Typography
                        className={clsx(classes.btnfonts, "restaurants-font")}
                      >
                        View Restaurants
                      </Typography>
                    </Button>
          ...
          <Carousel nextIcon={false} prevIcon={false}>
            <Carousel.Item>
              ...
              <Carousel.Caption style={{ top: "5%", zIndex: 2 }}>
                <Typography
                  className={`${classes.fonts} ${classesMobile.sliderSlogan}`}
                >
                  Delicious Healthy Food
                </Typography>
                <form
                  id="form-style"
                  onSubmit={handleSubmit}
                  className={classesMobile.form}
                  noValidate
                  autoComplete="off"
                >
                  <FormControl
                    variant="outlined"
                    className={classesMobile.firstFormControl}
                  >
                    {/* <TextField 
                                            id="filled-basic"  
                                            variant="filled"
