          ...
          <Link to="/FoodDelivery" className={classes.links} id="categories">
            <Card className={classes.card}>
              <CardMedia className={classes.cardImage}>
                <img
                  src="Images/FoodDeliveryServiceSM.png"
                  alt="FoodDeliveryServiceSM"
                ></img>
              </CardMedia>
        ...
        <Grid item xs={12} md={3}>
          ...
          <LightTooltip title="Coming Soon" placement="top-end">
            <Card className={classes.card}>
              <CardMedia className={classes.cardImage}>
                <img
                  src="Images/yellowtruckIconImageSM.png"
                  alt="GreenMarketPlace"
                ></img>
              </CardMedia>
              <CardContent className={classes.cardContent}>
        ...
        <Grid item xs={12} md={3}>
          ...
          <LightTooltip title="Coming Soon" placement="top-end">
            <Card className={classes.card}>
              <CardMedia className={classes.cardImage}>
                <img
                  src="Images/GreenMarketPlace.png"
                  alt="yellowtruckIconImageSM"
                ></img>
              </CardMedia>
              <CardContent className={classes.cardContent}>
