            ...
            <Grid item xs={12} md={3}>
              ...
              >
                <Button
                  ...
                  startIcon={
                    <img
                      src="Images/YellowRectangle.png"
                      style={{ width: "50%" }}
                      alt="google icon"
                    />
                  }
              ...
              <a className={classes.links} href="/" title="Coming Soon">
                <Button
                  variant="outlined"
                  //color="default"
                  startIcon={
            ...
            <Grid item xs={12} md={9}>
              ...
              <Typography style={{ textAlign: "center" }} variant="caption">
                <Typography className={classes.Typo2Mobile}>
                  Ease your everyday life, by allowing
                  <br />
                  us to take care of all your errands and delivery needs.
                </Typography>
              </Typography>
            </Grid>
          </Grid>
