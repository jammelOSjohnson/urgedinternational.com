    ...
    <>
            ...
            <Grid item xs={12} container spacing={1}>
              <Grid item xs={7} md={7} lg={7}>
                <img
                  ...
                  src="Images/urged logo white.svg"
                  alt="Urged Logo"
                ></img>
                <div className={classes.leftSection}>
                  <div style={{ textAlign: "left" }}>
                    <img
                      src="Images/RiderBackground.png"
              ...
              <Grid item xs={5} md={5} lg={5}>
                <div className={classes.formSection}>
                  ...
                  <Typography variant="h6" className={classes.helloStyle}>
                    Hello,
                  </Typography>
                  <Typography
                    variant="subtitle1"
                  ...
                  >
                    <FormControl fullWidth variant="outlined">
                      <InputLabel htmlFor="fullname" className={classes.root}>
                        Full Name
                      </InputLabel>
                      <OutlinedInput
                    ...
                    <br />
                    <FormControl fullWidth variant="outlined">
                      <InputLabel htmlFor="email" className={classes.root}>
                        Email Address
                      </InputLabel>
                      <OutlinedInput
                        className={clsx(classes.firstTextField, classes.root)}
                    ...
                    <br />
                    <FormControl fullWidth variant="outlined">
                      <InputLabel htmlFor="password" className={classes.root}>
                        Password
                      </InputLabel>
                      <OutlinedInput
      ...
      {isMatch ? (
        ...
        >
          <Button
            variant="outlined"
            className={clsx(classes.signUpBtnMobile, mobClasses.root)}
            onClick={handleClickSignIn}
          >
            Sign In
          </Button>
          ...
          <div className={classes.formSectionMobile}>
            <Typography variant="h5" className={classes.helloStyleMobile}>
              Hello,
            </Typography>
            <Typography variant="subtitle1" className={classes.welcomeStyle}>
              Welcome Back
            </Typography>
            <form
              onSubmit={handleSubmit}
            ...
            >
              ...
              <br />
              <FormControl fullWidth variant="outlined">
                <InputLabel htmlFor="email" className={mobClasses.root}>
                  Email Address
                </InputLabel>
                <OutlinedInput
                  className={clsx(
              ...
              <FormControl fullWidth variant="outlined" color="secondary">
                <InputLabel htmlFor="password" className={mobClasses.root}>
                  Password
                </InputLabel>
                <OutlinedInput
              ...
              <Typography variant="subtitle2" className={classes.orTextMobile}>
                Or
              </Typography>
              <Button
                variant="outlined"
