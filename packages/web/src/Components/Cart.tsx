...
export const Cart: React.FC = function Cart() {
  ...
  const handleMenuItemClose = (event: React.MouseEvent<HTMLElement>) => {
    setOpen(false);
  };
              ...
              <ClickAwayListener onClickAway={handleClose}>
                <Grid container direction="row" spacing={1}>
                  ...
                  <Grid item xs={12}>
                    ...
                    >
                        {/*<MenuItem key={idex} onClick={handleClose}></MenuItem>*/}
                      {cartItems.length > 0 ? (
                        cartItems.map((item, idex) => (
                          <MenuItem key={idex} onClick={handleMenuItemClose}>
                            <Grid item xs={8}>
                              <Grid container direction="row" spacing={1}>
                                <Grid item xs={6}>
                                  <img
                    ...
                    <Grid item xs={12} style={{ textAlign: "center" }}>
                      ...
                      >
                        <Button
                          size="large"
                          fullWidth={true}
                          className={clsx(classes.Button, classes.btnfonts)}
                          type="button"
                        >
                          Checkout
                        </Button>
